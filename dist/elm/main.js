...
var $author$project$Main$getParam = F3(
	function (url, paramName, defaultValue) {
		var parsedParam = A2(
			$elm$url$Url$Parser$parse,
			A2(
				$elm$url$Url$Parser$slash,
				$elm$url$Url$Parser$s('dist'),
				A2(
...
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		return _Utils_Tuple2(
			$author$project$Main$buildInit(url),
...
var $author$project$Main$emojiToString = function (code) {
...
var $author$project$Modal$render = function (props) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(props.content)
									]))
							]))
					]))
			]));
							...
							[
								...
								_List_fromArray(
									[
										...
										A2($elm$html$Html$Attributes$style, 'width', '23rem'),
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$id('sender')
											]),
										_List_fromArray(
											[
												$elm$html$Html$text('De: ' + md.config.from)
											])),
										A2(
										$elm$html$Html$span,
										_List_fromArray(
											[
												$elm$html$Html$Attributes$id('receiver')
											]),
										_List_fromArray(
											[
												$elm$html$Html$text('Para: ' + md.config.to)
											])),
										A2(
										$elm$html$Html$div,
										_List_fromArray(
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text(md.config.question)
													])),
												A2(
												$elm$html$Html$div,
												_List_fromArray(
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$text(md.config.from)
															])),
														A2(
														$elm$html$Html$button,
														_List_fromArray(
														...
														_List_fromArray(
															[
																$elm$html$Html$text(md.config.other)
															]))
													]))
											])),
										$author$project$Modal$render(
										{
											content: 'Eu sabia !!! ' + $author$project$Main$emojiToString(128536),
											id: 'win-modal',
											okText: 'OK',
											title: $author$project$Main$emojiToString(128525)
										}),
										$author$project$Modal$render(
										{
											content: 'Deixa de ser besta ' + $author$project$Main$emojiToString(128522),
											id: 'fail-modal',
											okText: 'OK',
											title: $author$project$Main$emojiToString(128515)
										})
									]))
							]))
					]))
